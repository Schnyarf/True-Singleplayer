    ...
    public void renderParticles(Entity par1Entity, float par2)
    {
        ...
        for (int var8 = 0; var8 < 3; ++var8)
        {
            if (!this.fxLayers[var8].isEmpty())
            {
                ...
                GL11.glDepthMask(false); // This line may need to be removed for some reason - Schf
                ...
                GL11.glDepthMask(true); // This line may need to be removed for some reason - Schf
