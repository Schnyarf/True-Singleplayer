...
public class ProvisionalEntityPlayerSP2 extends EntityClientPlayerMP
{
    ...
    public void sendChatMessage(String par1Str)
    {
        ...
        {
        	this.mc.getIntegratedServer().getCommandManager().executeCommand(this, par1Str);
        }
        else
        {
        	this.mc.ingameGUI.getChatGUI().printChatMessage((new StringBuilder()).append("<").append(username).append("> ").append(par1Str).toString());
        }
    }
