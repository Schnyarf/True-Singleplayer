...
public class GuiSelectWorld extends GuiScreen
{
    ...
    public void selectWorld(int par1)
    {
        ...
        if (!this.selected)
        {
            ...
            if (this.mc.enableSP)
            {
            	this.mc.setController(((SaveFormatComparator)this.saveList.get(par1)).getEnumGameType());
            	this.mc.startWorldSSP(var2, getSaveName(par1), null);
//                 MinecraftHook.startWorldHook(var2, getSaveName(par1), null);
