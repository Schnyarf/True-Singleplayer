...
//        GuiSelectWorld.getSMPSelectButton(this.parentWorldGui).enabled = var3; Removed the call function which highlights the "Play SMP" button but a more permanent solution needs to be reached - Schf
