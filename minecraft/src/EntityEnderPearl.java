...
public class EntityEnderPearl extends EntityThrowable
{
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        ...
        {
        	if (this.getThrower() != null && Minecraft.getMinecraft().enableSP)
        	{
        		this.getThrower().setPositionAndUpdate(posX, posY, posZ);
        		this.getThrower().fallDistance = 0.0F;
        		this.getThrower().attackEntityFrom(DamageSource.fall, 5);
        	}
        	else if (this.getThrower() != null && this.getThrower() instanceof EntityPlayerMP)
            {
