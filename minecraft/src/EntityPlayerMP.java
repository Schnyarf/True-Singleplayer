...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    {
    	return ("seed".equals(par2Str) || "publish".equals(par2Str)) && !this.mcServer.isDedicatedServer() ? true : (!"tell".equals(par2Str) && !"help".equals(par2Str) && !"me".equals(par2Str) && !"publish".equals(par2Str) ? (this.mcServer.getConfigurationManager().isPlayerOpped(this.username) ? this.mcServer.func_110455_j() >= par1 : false) : true); // There may be some silliness with /publish not being explicitly disallowed in a dedicated server context - Schf
    }
