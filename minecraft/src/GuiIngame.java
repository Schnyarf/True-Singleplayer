...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            if (!mc.theWorld.isRemote && mc.enableSP && ProvisionalSSPOptions.getDebugSeed())
            {
                drawString(var8, (new StringBuilder()).append("Seed: ").append(this.mc.theWorld.getSeed()).toString(), 2, 120, 0xe0e0e0);
            }
            GL11.glPopMatrix();
            this.mc.mcProfiler.endSection();
        }
        ...
        if (!this.mc.enableSP && this.mc.gameSettings.keyBindPlayerList.pressed && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.playerInfoList.size() > 1 || var43 != null))
        {
