...
public class Minecraft implements IPlayerUsage
{
    ...
    public Minecraft(Session par1Session, int par2, int par3, boolean par4, boolean par5, File par6File, File par7File, File par8File, Proxy par9Proxy, String par10Str)
    {
        ...
        this.useSP = true;
        this.enableSP = useSP;
        this.worldClass = ProvisionalWorldSSP.class;
        this.playerClass = ProvisionalEntityPlayerSP2.class;
...
//        if (this.theWorld != null && this.worldClass != WorldSSP.class)
//        {
...
//        }
        ...
        if ((this.gameSettings.showDebugInfo && this.gameSettings.showDebugProfilerChart) || this.startProfiling)
        {
        ...
        if (this.enableSP)
        {
            if (this.isIntegratedServerRunning() && this.thePlayer != null && this.getNetHandler() != null && this.isGamePaused != var5)
            {
                ((MemoryConnection)this.getNetHandler().getNetManager()).setGamePaused(this.isGamePaused);
            }
        }
        else
        {
            ...
            if (this.isIntegratedServerRunning() && this.thePlayer != null && ((EntityClientPlayerMP)this.thePlayer).sendQueue != null && this.isGamePaused != var5)
            {
    	        ((MemoryConnection)((EntityClientPlayerMP)this.thePlayer).sendQueue.getNetManager()).setGamePaused(this.isGamePaused);
            }
        }
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen != null)
        {
            ...
            if (this.currentScreen != null)
            {
                try
                {
                    this.currentScreen.updateScreen2();
                }
        ...
        if (this.theWorld != null)
        {
            if (this.timecontrol && this.enableSP && this.currentScreen == null && (!isom || !GuiScreen.isShiftKeyDown()))
            {
                if(Keyboard.isKeyDown(64))
                {
                    ((ProvisionalWorldSSP)this.theWorld).field_35465_L -= 0.001D;
                }
                if(Keyboard.isKeyDown(65))
                {
                    ((ProvisionalWorldSSP)this.theWorld).field_35465_L += 0.001D;
    ...
    public void startWorldSSP(String par1Str, String par2Str, WorldSettings par3WorldSettings)
    {
       ...
       // this.theIntegratedServer = new IntegratedServer(this, par1Str, par2Str, par3WorldSettings2); // Readded fake server code - Schf
        ...
        else
        {
            ...
            {
                this.loadingScreen.resetProgressAndMessage(StatCollector.translateToLocal("menu.switchingLevel"));
                this.loadingScreen.resetProgresAndWorkingMessage("");
            }

            ISaveHandler var4 = this.saveLoader.getSaveLoader(par1Str, false);
            ProvisionalWorldSSP var5 = null;

            try
            {
                Object o = this.worldClass.getDeclaredConstructor(new Class[]{ISaveHandler.class, String.class, WorldSettings.class, Profiler.class, ILogAgent.class}).
                           newInstance(new Object[]{var4, par2Str, par3WorldSettings, this.mcProfiler, getLogAgent()});
                var5 = (ProvisionalWorldSSP)o;
//                var5 = new ProvisionalWorldSSP(var4, par2Str, par3WorldSettings, this.mcProfiler, getLogAgent());
            }
            catch(Exception ex)
            {
                ex.printStackTrace();
        ...
        this.lastWorld = par1Str;
       // this.theIntegratedServer.setCommandManager(new ClientCommandManager()); // Temporary command manager patch - Schf
    }
    ...
    public void usePortal(int par1)
    {
        ...
        if (this.thePlayer.dimension == -1)
        {
            ...
            ProvisionalWorldSSP world = null;
            try
            {
                Object o = this.worldClass.getDeclaredConstructor(new Class[]{ProvisionalWorldSSP.class, WorldProvider.class, Profiler.class, ILogAgent.class}).
                           newInstance(new Object[]{(ProvisionalWorldSSP)this.theWorld, WorldProvider.getProviderForDimension(this.thePlayer.dimension), this.mcProfiler, getLogAgent()});
                world = (ProvisionalWorldSSP)o;
//                world = new WorldSSP((WorldSSP)theWorld, WorldProvider.getProviderForDimension(thePlayer.dimension), mcProfiler, getLogAgent());
        ...
        else if (this.thePlayer.dimension == 0)
        {
            ...
            ProvisionalWorldSSP world1 = null;
            try
            {
                Object o = this.worldClass.getDeclaredConstructor(new Class[]{ProvisionalWorldSSP.class, WorldProvider.class, Profiler.class, ILogAgent.class}).
                           newInstance(new Object[]{(ProvisionalWorldSSP)this.theWorld, WorldProvider.getProviderForDimension(this.thePlayer.dimension), this.mcProfiler, getLogAgent()});
                world1 = (ProvisionalWorldSSP)o;
//                world1 = new ProvisionalWorldSSP((ProvisionalWorldSSP)this.theWorld, WorldProvider.getProviderForDimension(this.thePlayer.dimension), this.mcProfiler, getLogAgent());
            }
            catch(Exception ex)
            {
                ex.printStackTrace();
        ...
        {
        	ProvisionalWorldSSP world2 = null;
            try
            {
                Object o = this.worldClass.getDeclaredConstructor(new Class[]{ProvisionalWorldSSP.class, WorldProvider.class, Profiler.class, ILogAgent.class}).
                           newInstance(new Object[]{(ProvisionalWorldSSP)this.theWorld, WorldProvider.getProviderForDimension(this.thePlayer.dimension), this.mcProfiler, getLogAgent()});
                world2 = (ProvisionalWorldSSP)o;
//                world2 = new ProvisionalWorldSSP((ProvisionalWorldSSP)this.theWorld, WorldProvider.getProviderForDimension(this.thePlayer.dimension), this.mcProfiler, getLogAgent());
            }
            catch(Exception ex)
            {
                ex.printStackTrace();
            ...
            ChunkCoordinates var10 = world2.getEntrancePortalLocation();
            var3 = var10.posX;
        ...
        System.out.println((new StringBuilder()).append("Teleported to ").append(this.theWorld.provider.dimensionId).toString());

        if (this.thePlayer.isEntityAlive() && var2 < 1)
        {
            this.thePlayer.setLocationAndAngles(var3, this.thePlayer.posY, var5, this.thePlayer.rotationYaw, this.thePlayer.rotationPitch);
            this.theWorld.updateEntityWithOptionalForce(this.thePlayer, false);
            (new ProvisionalTeleporterSP()).placeInPortal(this.theWorld, this.thePlayer, var3, this.thePlayer.posY, var5, this.thePlayer.rotationYaw);
        }
    }
     ...
     */
    public void changeWorld1(ProvisionalWorldSSP par1ProvisionalWorldSSP)
    {
        this.changeWorld2(par1ProvisionalWorldSSP, "");
    }

    /**
     * Changes the world with given message, no player.
     */
    public void changeWorld2(ProvisionalWorldSSP par1ProvisionalWorldSSP, String par2Str)
    {
        this.changeWorld(par1ProvisionalWorldSSP, par2Str, null);
    }

    /**
     * first argument is the world to change to, second one is a loading message and the third the player itself
     */
    public void changeWorld(ProvisionalWorldSSP par1ProvisionalWorldSSP, String par2Str, EntityPlayer par3EntityPlayer)
    {
//         this.statFileWriter.func_27175_b();
        ...
        if (this.theWorld != null)
        {
            ((ProvisionalWorldSSP)this.theWorld).saveWorldIndirectly(this.loadingScreen);
        }

        this.theWorld = par1ProvisionalWorldSSP;

        if (par1ProvisionalWorldSSP != null)
        {
            this.commandManager = new ClientCommandManager(); // CommandManager test - Schf

            if (!this.isMultiplayerWorld())
            {
                if (par3EntityPlayer == null)
                {
                    this.thePlayer = (ProvisionalEntityPlayerSP2)par1ProvisionalWorldSSP.func_4085_a(ProvisionalEntityPlayerSP2.class);
                }
            }
            else if (this.thePlayer != null)
            {
                ...
                if (par1ProvisionalWorldSSP != null)
                {
                    par1ProvisionalWorldSSP.spawnEntityInWorld(this.thePlayer);
                }
            }

            if (!par1ProvisionalWorldSSP.isRemote)
            {
            ...
            if (this.thePlayer == null)
            {
                this.thePlayer = this.playerController.func_78754_a(par1ProvisionalWorldSSP);
                this.thePlayer.preparePlayerToSpawn();
            ...
            if (this.renderGlobal != null)
            {
                this.renderGlobal.setWorldAndLoadRenderers(par1ProvisionalWorldSSP);
            }

            if (this.effectRenderer != null)
            {
                this.effectRenderer.clearEffects(par1ProvisionalWorldSSP);
            }

            IChunkProvider var4 = par1ProvisionalWorldSSP.getChunkProvider();
            ...
            par1ProvisionalWorldSSP.spawnPlayerWithLoadedChunks(this.thePlayer);
            this.playerController.setPlayerCapabilities(this.thePlayer);

            if (par1ProvisionalWorldSSP.isNewWorld)
            {
                ((ProvisionalWorldSSP)par1ProvisionalWorldSSP).saveWorldIndirectly(this.loadingScreen);
            }
    ...
    {
        this.loadingScreen.resetProgressAndMessage("Converting World to Anvil"); // This may need to be changed - Schf
        this.loadingScreen.resetProgresAndWorkingMessage("This may take a while :)");
        this.saveLoader.convertMapFormat(par1Str, this.loadingScreen);
        this.startWorldSSP(par1Str, par2Str, new WorldSettings(0L, EnumGameType.SURVIVAL, true, false, WorldType.DEFAULT));
    }
    ...
    private void preloadWorld(String par1Str)
    {
        if (this.loadingScreen != null)
        {
            this.loadingScreen.resetProgressAndMessage(par1Str);
            this.loadingScreen.resetProgresAndWorkingMessage(StatCollector.translateToLocal("menu.generatingTerrain"));
        }

        char var2 = '\200';

        if (((PlayerController)this.playerController).func_35643_e())
        {
            var2 = '@';
        }
...
//                }
        ...
        if (!((PlayerController)this.playerController).func_35643_e())
        {
            if (this.loadingScreen != null)
            {
                this.loadingScreen.resetProgresAndWorkingMessage(StatCollector.translateToLocal("menu.simulating"));
            }

            char c1 = 2000;
            ((ProvisionalWorldSSP)this.theWorld).dropOldChunks();
        }
    }
    ...
    {
        if (!this.theWorld.isRemote && !this.theWorld.provider.canRespawnHere())
        {
            this.usePortal(0);
        }
        ...
        {
            var4 = this.thePlayer.getBedLocation();

            if (var4 != null)
            {
                var5 = EntityPlayer.verifyRespawnCoordinates(this.theWorld, var4, this.thePlayer.isSpawnForced());
        ...
        ((ProvisionalWorldSSP)this.theWorld).updateEntityList();
        int var10 = 0;
        ...
        this.thePlayer.clonePlayer(var9, par3);
        ...
        if (var6)
        {
            this.thePlayer.setSpawnChunk(var4, false);
            this.thePlayer.setLocationAndAngles((float)var5.posX + 0.5F, (float)var5.posY + 0.1F, (float)var5.posZ + 0.5F, 0.0F, 0.0F);
        }

        this.playerController.flipPlayer(this.thePlayer);
        ((ProvisionalWorldSSP)this.theWorld).spawnPlayerWithLoadedChunks(this.thePlayer);
        this.thePlayer.movementInput = new MovementInputFromOptions(this.gameSettings);
    ...
    public void setController(EnumGameType enumgametype)
    {
        ...
        {
        	this.playerController = new PlayerControllerAdventure(this);
            return;
        }
    }
    ...
    public void setGameMode(EnumGameType enumgametype)
    {
        if (enumgametype == EnumGameType.SURVIVAL)
        {
            PlayerControllerCreative.disableAbilities(this.thePlayer);
            PlayerControllerAdventure.enableAbilities(this.thePlayer);
            return;
        }
        if (enumgametype == EnumGameType.CREATIVE)
        {
            PlayerControllerCreative.enableAbilities(this.thePlayer);
            PlayerControllerAdventure.enableAbilities(this.thePlayer);
            return;
        }
        if (enumgametype == EnumGameType.ADVENTURE)
        {
            PlayerControllerCreative.disableAbilities(this.thePlayer);
            PlayerControllerAdventure.disableAbilities(this.thePlayer);
            return;
        }
    }
    ...
    {
        if (getIntegratedServer() != null || this.enableSP == false)
        {
            return;
        }
        EnumGameType type = this.theWorld.getWorldInfo().getGameType();
        boolean commands = this.theWorld.getWorldInfo().areCommandsAllowed();
        ProvisionalWorldSSP world = (ProvisionalWorldSSP)this.theWorld;
        world.saveWorld(false, this.loadingScreen);
        changeWorld1(null);
        displayGuiScreen(null);
        this.enableSP = false;
        String s = this.lastWorld;
        String s1 = world.getWorldInfo().getWorldName();
        this.launchIntegratedServer(s, s1, null);
//        System.out.println(this.thePlayer.getEntityName());
//        this.thePlayer.sendGameTypeToPlayer(type);
    }

    public void switchSSP(boolean b)
    {
        if (this.isMultiplayerWorld() && !this.isSingleplayer())
        {
            return;
        }
        WorldClient world = this.theWorld;
        GuiScreen gui = this.currentScreen;
        String s1 = "";
        if (this.enableSP)
        {
            ((ProvisionalWorldSSP)world).saveWorld(false, this.loadingScreen);
            s1 = world.getWorldInfo().getWorldName();
            this.changeWorld1(null);
        }
        else
        {
            s1 = this.getIntegratedServer().getWorldName();
            this.theWorld.sendQuittingDisconnectingPacket();
            for (int i = 0; i < this.getIntegratedServer().worldServers.length; i++)
            {
                WorldServer worldserver = this.getIntegratedServer().worldServers[i];
                if (worldserver != null)
                {
                    worldserver.flush();
                    worldserver = null;
        ...
        if (this.enableSP)
        {
        	this.setController(world.getWorldInfo().getGameType());
            this.startWorldSSP(s, s1, null);
        }
        else
        {
        	this.launchIntegratedServer(s, s1, null);
        }
        this.displayGuiScreen(gui);
    }
    ...
    {
        return new File(this.mcDataDir, par1Str);
    }

    public String[] getAllUsernames()
    {
        return new String[]{this.thePlayer.getEntityName()};
    }
